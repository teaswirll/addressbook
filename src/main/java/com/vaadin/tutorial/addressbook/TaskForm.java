...
public class TaskForm extends FormLayout {
    ...
    public void save(Button.ClickEvent event) {
        try {
            ...
            String msg = String.format("Saved '%s %s'.", currentTask.getFirstName(),
                    currentTask.getLastName());
    ...
    public void delete(Button.ClickEvent event) {
        ...
        Notification.show("Delete", Type.TRAY_NOTIFICATION);
